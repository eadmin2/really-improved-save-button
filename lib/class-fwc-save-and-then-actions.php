 ...
 */
class FWC_Save_And_Then_Actions {
	 ...
	 * New actions register by hooking on the fwc-sat_load_actions filter
	 * and adding an instance of themselves in the supplied array.
	 */
	static function load_actions() {
		self::$actions = apply_filters( 'fwc-sat_load_actions', self::$actions );
	}
	 ...
	 * 
	 * @param  string $action_id
	 * @return FWC_Save_And_Then_Action|null
	 */
